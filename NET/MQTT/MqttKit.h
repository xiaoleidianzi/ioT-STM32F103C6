...
enum MqttPacketType
{
    ...
    MQTT_PKT_UNSUBSCRIBE = 10, /**< 取消订阅数据包 */
    MQTT_PKT_UNSUBACK = 11,    /**< 取消订阅确认数据包 */
    MQTT_PKT_PINGREQ = 12,     /**< ping 数据包 */
    MQTT_PKT_PINGRESP = 13,    /**< ping 响应数据包 */
    MQTT_PKT_DISCONNECT = 14,  /**< 断开连接数据包 */
